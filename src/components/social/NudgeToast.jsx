    ...
    <AnimatePresence>
      {nudge && (
        <motion.div
          ...
          style={{ background: nudge.type === 'pepp' ? 'rgba(15,222,189,0.15)' : 'rgba(246,173,85,0.15)', border: `1px solid ${nudge.type === 'pepp' ? 'rgba(15,222,189,0.4)' : 'rgba(246,173,85,0.4)'}`, backdropFilter: 'blur(12px)' }}
        >
          <span className="text-2xl">{nudge.type === 'pepp' ? '🙌' : '🔥'}</span>
