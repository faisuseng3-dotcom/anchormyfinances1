  ...
  return (
    <>
      <motion.button
        ...
        style={{ background: 'rgba(75,124,243,0.07)', boxShadow: 'var(--anchor-shadow-1)' }}
      >
        ...
        {open && (
          ...
          >
            <motion.div
              ...
              style={{ background: '#1A2B3C', boxShadow: 'var(--anchor-shadow-1)', maxHeight: '90vh', overflowY: 'auto' }}
            >
              {/* Header */}
