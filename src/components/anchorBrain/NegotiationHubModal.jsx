      ...
      >
        ...
        >
          ...
          <div className="p-6">
            ...
            <p className="text-xs text-white/40 mb-5">Mobilabonnemang · Identifierad av AI</p>
            ...
            <div className="space-y-3 mb-5">
              <div className="flex items-center gap-3 p-3 rounded-xl bg-rose-500/10 border border-rose-500/20">
                ...
                <div className="flex-1">
                  <p className="text-xs text-white/45">Nuvarande</p>
              ...
              <div className="flex items-center justify-center">
                <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-[#4fae82]/20 border border-emerald-500/30">
                  <ArrowRight className="w-3.5 h-3.5 text-emerald-400" />
                  <span className="text-xs text-emerald-300 font-semibold">Spara 1 200 kr/år</span>
                </div>
              </div>

              <div className="flex items-center gap-3 p-3 rounded-xl bg-[#4fae82]/10 border border-emerald-500/20">
                <div className="w-8 h-8 rounded-lg bg-[#4fae82]/20 flex items-center justify-center flex-shrink-0">
                  <span className="text-xs font-bold text-emerald-400">H</span>
                </div>
                <div className="flex-1">
                  <p className="text-xs text-white/45">Förslag</p>
            ...
            {/* AI Script */}
            <div className="mb-5">
              <p className="text-xs text-white/40 mb-2 tracking-wide">Förhandlingsmanus</p>
              <div
                className="p-3 rounded-xl text-xs text-white/70 leading-relaxed"
            ...
            <div className="flex gap-3">
              <Button onClick={handleCopy} className="flex-1 rounded-xl bg-[#4fae82] hover:opacity-90 text-white text-sm">
                {copied ? <CheckCircle className="w-4 h-4 mr-1.5" /> : <Copy className="w-4 h-4 mr-1.5" />}
                {copied ? 'Kopierat!' : 'Kopiera manus'}
              </Button>
              <Button onClick={onClose} variant="outline" className="flex-1 rounded-2xl-white/10 hover:bg-white/5 text-white/70 text-sm">
                Stäng
              </Button>
            </div>
          </div>
