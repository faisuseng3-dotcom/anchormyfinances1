...
export const GALAXY_DEMO_PROFILES = [
  {
    ...
    avatar_config: {
      skinColor: '#FDBCB4',
      hair: { style: 'short_clean', color: '#3D2B1F' },
      outfit: { style: 'tshirt', color: '#4B7CF3' },
      bg: '#4B7CF3',
  ...
  },
  {
    ...
    avatar_config: {
      skinColor: '#C68642',
      hair: { style: 'bun_top', color: '#1A0A00' },
      outfit: { style: 'blazer', color: '#A78BFA' },
      bg: '#A78BFA',
      eyes: { type: 'round', color: '#4A7C59' },
      eyebrows: { type: 'arched' },
      eyelashes: { type: 'dramatic' },
      nose: { type: 'narrow' },
      mouth: { type: 'pouty', lipColor: '#E91E63' },
      faceShape: 'heart',
      accessory: 'earrings',
      expression: 'happy',
    },
  ...
  },
  {
    ...
    avatar_config: {
      skinColor: '#8D5524',
      hair: { style: 'short_clean', color: '#1C1C1C' },
      outfit: { style: 'hoodie', color: '#5B7CFA' },
      bg: '#5B7CFA',
      eyes: { type: 'hooded', color: '#3B2314' },
      eyebrows: { type: 'thick' },
      eyelashes: { type: 'none' },
      nose: { type: 'wide' },
      mouth: { type: 'smile', lipColor: '#C48A8A' },
